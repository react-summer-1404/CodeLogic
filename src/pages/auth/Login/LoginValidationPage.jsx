                ...
                <div className=' flex flex-1 flex-col  p-17  gap-10 '>
                    ...
                    <div className='flex flex-col justify-center items-center gap-3 p-5 '>
                        ...
                        <form className='w-full flex flex-col gap-16 mt-7 px-7 ' >
                            ...
                            <button className='w-full bg-[#008C78] text-white text-[14px] rounded-full px-5 py-3 hover : bg-8/10  transition-all duration-300 ease-in-out hover:scale-[1.03] hover:shadow-md active:scale-[0.98] '>تایید رمز یکبار مصرف</button>
                        </form>
