...
import NewsSelectOne from '../../components/news/NewsSelectOne/NewsSelectOne.jsx';
import NewsSelectTwo from '../../components/news/NewsSelectTwo/NewsSelectTwo.jsx';
...
const NewsPage = () => {
    ...
    const filteredNews = useMemo(() => {
        ...
        if (selectedCategory) {
            result = result.filter((news) => news.newsCatregoryName === selectedCategory);
        }
                ...
                <div className="w-full sm:w-3/4 lg:w-[79%] sm:ml-6">
                    ...
                    >
                        <div className="flex flex-wrap justify-center sm:justify-start items-center !gap-4">
                            <span className="dark:text-[#fff] text-sm">{t('newsPage.sortBy')}</span>
