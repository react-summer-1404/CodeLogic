                            ...
                            >
                                ...
                                <div className="w-full relative">
                                    <Field
                                        ...
                                        name="oldPassword"
                                        id="oldPassword"
                                        className="w-full relative bg-[#FFFFFF] dark:bg-[#454545] placeholder:text-[16px] focus:outline-none
                            ...
                            >
                                ...
                                <div className="w-full relative ">
                                    <Field
                                        ...
                                        name="newPassword"
                                        id="newPassword"
                                        className="w-full dark:bg-[#454545] bg-[#FFFFFF] placeholder:text-[16px] focus:outline-none
                                     placeholder:text-[#848484] rounded-[16px] py-2 px-3  border border-[#EAEAEA] shadow "
                                    />
                                    <img
