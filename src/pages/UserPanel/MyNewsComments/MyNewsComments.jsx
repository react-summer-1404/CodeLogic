    ...
    <div className='flex flex-col gap-10 h-[85%] p-8 bg-[#F3F4F6] rounded-4xl   dark:bg-[#333333]'>
      ...
      <div className='h-[440px] p-6 bg-[#FFFFFF] rounded-2xl   dark:bg-[#454545]'>
        ...
        titleData={{
          ...
          title2: t('myNewsComments.title2'), pr2: 'pr-[112px]',
          title3: t('myNewsComments.title3'), pr3: 'pr-20',
          title4: t('myNewsComments.title4'), pr4: 'pr-[168px]',
          title5: t('myNewsComments.title5'), pr5: 'pr-[104px]',
          title6: t('myNewsComments.title6'), pr6: 'pr-20',
        }}/>
      </div>
      <div className='flex justify-between items-center'>
        <ReactPaginate
