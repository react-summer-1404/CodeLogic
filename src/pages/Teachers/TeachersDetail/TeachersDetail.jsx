                ...
                <motion.div
                    ...
                    <div
                        ...
                        <div className='flex gap-4 text-[#008C78] text-[14px] '>
                            ...
                            <span>&gt;</span>
                            <Link to={'/Teachers'} className='hover:text-blue-500 transition duration-300'>{t('teachersPage.titles.Teachers')}</Link>
                            <span>&gt;</span>
                    ...
                    <div className=' flex flex-col md:flex-row md:flex-nowrap gap-10 w-full  justify-between pt-4 pb-20 '>
                        ...
                        <div className='w-[100%] md:w-[80%] flex flex-col justify-center mx-auto md:mx-0'>
                            ...
                            <div ref={sliderRef} className='w-full flex flex-nowrap justify-items-start md:flex-wrap md:justify-between overflow-y-hidden overflow-x-auto scroll-smooth pb-4 gap-4 ' style={{ direction: "ltr" }}>
                                {cuuruntDetail.length > 0 ? (cuuruntDetail.map((item, index) => (
                                    <DetailCard item={item} key={item.id} />))) : (
                            ...
                            <div className='  flex items-center justify-center gap-3' style={{ direction: "ltr" }} >
                                ...
                                <button disabled={curruntPage === totalPage} onClick={handleNext} className='cursor-pointer shadow-lg text-center w-[50px] h-[50px] rounded-[15px] p-3 bg-[#EAEAEA] dark:text-[#ffff] dark:bg-[#606060] text-[#1E1E1E]"} bg-[url(/icons/right.png)] bg-[center_center] bg-no-repeat '></button>
                            </div>
                        </div>
                    </div>
