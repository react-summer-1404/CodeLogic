...
const TeachersPage = () => {
    ...
    const filteredTeachers = TeachersData.filter((teachers) => teachers.title.toLowerCase().includes(searchTerm.trim().toLowerCase()))
    ...
    const varients = {
        ...
        enter: {
            opacity: 1, x: 0,
            transition: { type: "spring", stiffness: 250, duration: 0.25, delay: 0.2 }
        },
        exit: {
            opacity: 0, x: -40,
            transition: { type: "spring", stiffness: 250, duration: 0.25, delay: 0.2 }
