...
const SliderTeacher = ({item}) => {
  ...
  return (
    <div className='flex flex-col flex-shrink-0 items-center w-[350px] h-[346px] p-4 bg-[#FFFFFF] rounded-[20px]
    hover:shadow-[0_4px_4px_rgba(0,0,0,0.25)]'>
      <img src={item.img}/>
      <div className='flex flex-col items-center gap-2 pt-2'>
        <span className='font-bold text-base text-[#1E1E1E]'>{t(`${item.title}`)}</span>
