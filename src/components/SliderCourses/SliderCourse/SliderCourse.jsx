...
const SliderCourse = ({item}) => {
  ...
  return (
    ...
    hover:shadow-[0_4px_4px_rgba(0,0,0,0.25)]'>
        <img className='w-full h-[259px] rounded-t-[20px]' src={item.imageAddress}/>
        <div className='flex flex-col justify-between w-[350px] h-[217px] mb-[-16px] p-4 bg-[#FFFFFF] rounded-[20px] transform -translate-y-4   
        dark:bg-[#606060]'>
